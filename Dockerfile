...
#xenial is the ubuntu image of local system
FROM xenial:latest
MAINTAINER cjm8481447
...
RUN wget http://apache.mirrors.tds.net/hadoop/common/hadoop-2.9.0/hadoop-2.9.0.tar.gz
Run tar -xzvf hadoop-2.9.0.tar.gz
RUN mv hadoop-2.9.0 /usr/local/hadoop
